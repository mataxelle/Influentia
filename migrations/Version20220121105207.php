 ...
 */
final class Version20220121105207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE posts (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, author VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, publication_date DATETIME NOT NULL, update_date DATETIME NOT NULL, published TINYINT(1) NOT NULL, INDEX IDX_885DBAFAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prenium_posts (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, author VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, publication_date DATETIME NOT NULL, update_date DATETIME NOT NULL, published TINYINT(1) NOT NULL, price INT NOT NULL, INDEX IDX_DEEA593FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE prenium_posts ADD CONSTRAINT FK_DEEA593FA76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prenium_posts DROP FOREIGN KEY FK_DEEA593FA76ED395');
